...
The <code style="color:navy;">citeimage</code> datamodel has only three properties:
...
For the <code style="color:navy;">citebinaryimage</code> datamodel:

There is a collection implementing <code style="color:navy;">citeimage</code>.
...
- The file was 8x as large as our current CEX (even with less data).
